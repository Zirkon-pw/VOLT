...
const fallbackMessages: Record<string, string> = {
  ...
  'editor.context.addLink': 'Add link',
  'editor.context.bold': 'Bold',
  'editor.context.copyLink': 'Copy link',
  'editor.context.italic': 'Italic',
  'editor.context.openLink': 'Open link',
  'editor.context.plainText': 'Plain text',
  'editor.context.strikethrough': 'Strikethrough',
  'editor.context.underline': 'Underline',
