...
const LIGHT_THEME_TOKENS: ThemeTokens = {
  ...
  '--surface-translucent-primary': 'rgba(251, 248, 243, 0.72)',
  '--surface-translucent-secondary': 'rgba(241, 234, 225, 0.6)',
...
const DARK_THEME_TOKENS: ThemeTokens = {
  ...
  '--surface-translucent-primary': 'rgba(38, 35, 33, 0.7)',
  '--surface-translucent-secondary': 'rgba(32, 29, 27, 0.58)',
