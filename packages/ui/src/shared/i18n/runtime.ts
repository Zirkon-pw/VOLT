...
const fallbackMessages: Record<string, string> = {
  ...
  'settings.plugins.incompatible': 'This plugin is not available on the current platform.',
  'settings.plugins.incompatibleReason': 'Unavailable on this platform: {reason}',
  ...
  'editor.table.cellColor': 'Cell color',
  'editor.table.clearCellColor': 'Clear cell color',
  'editor.table.deleteColumn': 'Delete column',
  'editor.table.deleteRow': 'Delete row',
  'editor.table.deleteTable': 'Delete table',
  'editor.table.selectColumn': 'Select column',
  'editor.table.selectRow': 'Select row',
  'editor.table.selectTable': 'Select table',
