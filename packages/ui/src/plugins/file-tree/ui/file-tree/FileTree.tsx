...
export function FileTree({ voltId, locator, onFileOpen }: FileTreeProps) {
  ...
  useEffect(() => {
    void loadTree(voltId, locator).catch(() => undefined);
  }, [loadTree, voltId, locator]);
          ...
          <div className={styles.list}>
            {isDragging ? (
              <div
                ...
                onDrop={(event) => {
                  event.preventDefault();
                  event.stopPropagation();
                  void commitMove(voltId, locator);
                }}
              />
            ) : null}
            ...
            {showRootCreate && pendingCreate ? (
              <FileTreeInlineEditor
                ...
                onSubmit={async () => {
                  await commitInlineEdit(voltId, locator);
                }}
      ...
      >
        ...
        <div className={styles.modalActions}>
          ...
          <Button
            ...
            size="md"
            onClick={() => {
              void confirmDelete(voltId, locator);
            }}
          >
            {t('common.delete')}
          </Button>
