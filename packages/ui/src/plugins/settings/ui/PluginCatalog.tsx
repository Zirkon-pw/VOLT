      ...
      {plugins.length === 0 ? (
        ...
        <div className={styles.pluginList}>
          {plugins.map((plugin) => {
            ...
            const isUnsupported = !plugin.compatibility.supported;
            return (
                  ...
                  <div className={styles.pluginInfo}>
                    ...
                    {isUnsupported && (
                      <div className={styles.pluginDescription}>
                        {t('settings.plugins.incompatibleReason', {
                          reason: plugin.compatibility.reason ?? t('settings.plugins.incompatible'),
                        })}
                      </div>
                    )}
                  </div>
